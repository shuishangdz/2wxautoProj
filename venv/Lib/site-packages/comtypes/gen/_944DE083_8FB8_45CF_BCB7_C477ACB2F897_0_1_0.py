...
__all__ = [
    'IUIAutomation3', 'UIA_ToolTipControlTypeId',
    'UIA_PaneControlTypeId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_Transform2ZoomMaximumPropertyId', 'TextUnit_Format',
    ...
    'UIA_RotationPropertyId', 'IUIAutomationElement8',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_RuntimeIdPropertyId', 'UIA_StylesStyleNamePropertyId',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_AnnotationTypesAttributeId', 'UIA_IsActiveAttributeId',
    'AnnotationType_UnsyncedChange', 'UIA_AnnotationPatternId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'AnnotationType_FormatChange', 'WindowVisualState',
    'StructureChangeType_ChildrenBulkRemoved', 'StyleId_Heading9',
    ...
    'SupportedTextSelection_Single', 'AnnotationType_FormulaError',
    'UIA_TextPattern2Id', 'ToggleState',
    'IUIAutomationSelectionPattern2', 'UIA_UnderlineColorAttributeId',
    'SynchronizedInputType_LeftMouseUp', 'HeadingLevel3',
    'StructureChangeType_ChildRemoved',
    'UIA_RangeValueSmallChangePropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_TreeControlTypeId', 'IUIAutomationVirtualizedItemPattern',
    'TextUnit_Paragraph', 'AutomationElementMode',
    'UIA_Transform2ZoomMinimumPropertyId', 'UIA_MenuControlTypeId',
    'UIA_IsItalicAttributeId', 'ExtendedProperty',
    'SynchronizedInputType_RightMouseDown', 'IUIAutomationTreeWalker',
    'UIA_FontSizeAttributeId', 'UIA_AutomationFocusChangedEventId',
    'TextEditChangeType_AutoComplete', 'IUIAutomationNotCondition',
    'UIA_AsyncContentLoadedEventId',
    'UIA_IndentationTrailingAttributeId',
    'NavigateDirection_PreviousSibling', 'UIA_MarginTopAttributeId',
    'ScrollAmount_LargeIncrement', 'UIA_ExpandCollapsePatternId',
    'ZoomUnit_LargeDecrement', 'AnnotationType_Highlighted',
    'UIA_TabItemControlTypeId', 'StructureChangeType',
    'IUIAutomation4', 'UIA_StrikethroughStyleAttributeId',
    'IUIAutomationOrCondition', 'TreeTraversalOptions_PostOrder',
    'UIA_DropTarget_DroppedEventId', 'IUIAutomationCondition',
    'UIA_StatusBarControlTypeId', 'SynchronizedInputType_KeyUp',
    'ExpandCollapseState_Collapsed',
    'TextEditChangeType_CompositionFinalized',
    'UIA_HeaderControlTypeId', 'UIA_SpreadsheetPatternId',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_TextEditPatternId', 'TextUnit_Page',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'IUIAutomationElementArray', 'CoalesceEventsOptions',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_TextEdit_TextChangedEventId', 'HeadingLevel4',
    'StyleId_Quote', 'IUIAutomationTextRange',
    'UIA_IsSuperscriptAttributeId', 'TextEditChangeType_Composition',
    'ExpandCollapseState', 'ProviderOptions_ServerSideProvider',
    'IUIAutomationLegacyIAccessiblePattern',
    'CoalesceEventsOptions_Enabled',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_GridItemRowPropertyId',
    'UIA_FrameworkIdPropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'ProviderOptions',
    'AutomationElementMode_Full', 'IUIAutomationSelectionItemPattern',
    'UIA_HyperlinkControlTypeId', 'NotificationProcessing_All',
    'UIA_GridRowCountPropertyId', 'AnnotationType_MoveChange',
    'UIA_OrientationPropertyId', 'TreeScope_Descendants',
    'IUIAutomationCustomNavigationPattern',
    'RowOrColumnMajor_ColumnMajor',
    'WindowInteractionState_NotResponding',
    'UIA_SayAsInterpretAsAttributeId',
    'UIA_FullDescriptionPropertyId', 'UIA_StylesShapePropertyId',
    'UIA_TableRowHeadersPropertyId', 'OrientationType_None',
    'UIA_WindowIsModalPropertyId', 'IUIAutomationElement4',
    'ScrollAmount_SmallIncrement',
    'UIA_AfterParagraphSpacingAttributeId',
    'NavigateDirection_FirstChild', 'UIA_IsOffscreenPropertyId',
    'IUIAutomationWindowPattern', 'AnnotationType_Endnote',
    'StructureChangeType_ChildrenReordered',
    'NotificationProcessing_MostRecent',
    'AnnotationType_DataValidationError', 'UIA_ToolBarControlTypeId',
    'UIA_GridPatternId', 'IUIAutomationTextRangeArray',
    'UIA_MenuBarControlTypeId', 'UIA_AppBarControlTypeId',
    'NotificationKind_Other', 'UIA_DropTarget_DragLeaveEventId',
    'AnnotationType_Sensitive', 'IUIAutomationScrollPattern',
    ...
    'UIA_OverlineColorAttributeId', 'AnnotationType_GrammarError',
    'UIA_AnnotationObjectsPropertyId',
    'AnnotationType_ExternalChange',
    'UIA_TableItemRowHeaderItemsPropertyId', 'StyleId_Heading7',
    'DockPosition_Fill', 'UIA_OverlineStyleAttributeId',
    'UIA_IsControlElementPropertyId', 'UIA_ButtonControlTypeId',
    'UIA_ScrollBarControlTypeId', 'ToggleState_Off',
    'StyleId_Heading2', 'ExpandCollapseState_Expanded',
    'PropertyConditionFlags_MatchSubstring',
    'ScrollAmount_LargeDecrement', 'UIA_DragDropEffectsPropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId', 'AnnotationType_Author',
    'IUIAutomationActiveTextPositionChangedEventHandler', 'Assertive',
    'StyleId_NumberedList', 'ProviderOptions_NonClientAreaProvider',
    'IUIAutomationTextChildPattern', 'UIA_IsHiddenAttributeId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'TextUnit_Word', 'UIA_RangeValueMinimumPropertyId',
    'UIA_PositionInSetPropertyId', 'IUIAutomationTextEditPattern',
    'UIA_SpreadsheetItemPatternId',
    'UIA_Transform2ZoomLevelPropertyId', 'UIA_FlowsToPropertyId',
    'IUIAutomationProxyFactoryMapping', 'DockPosition_Right',
    'IUIAutomationPropertyCondition', 'IUIAutomationTogglePattern',
    'ToggleState_Indeterminate', 'NavigateDirection_Parent',
    'UIA_TablePatternId', 'UIA_SelectionPatternId',
    'ProviderOptions_UseComThreading', 'DockPosition_Left',
    'UIA_ProgressBarControlTypeId', 'SynchronizedInputType',
    'UIA_TableColumnHeadersPropertyId', 'IUIAutomationTextPattern2',
    'AnnotationType_DeletionChange',
    'UIA_IsKeyboardFocusablePropertyId', 'IUIAutomationDragPattern',
    'UIA_AutomationIdPropertyId', 'UIA_IsEnabledPropertyId',
    'UIA_CheckBoxControlTypeId', 'UIA_OutlineStylesAttributeId',
    'UIA_LabeledByPropertyId', 'Off',
    ...
    'UIA_IsGridPatternAvailablePropertyId', 'StyleId_Heading3',
    'UIA_SelectionIsSelectionRequiredPropertyId', 'TextUnit_Line',
    'UIA_MenuModeEndEventId', 'AnnotationType_EditingLockedChange',
    'UIA_LocalizedLandmarkTypePropertyId', 'UiaChangeInfo',
    'IUIAutomationGridItemPattern', 'DockPosition',
    'ConnectionRecoveryBehaviorOptions',
    'UIA_TransformCanRotatePropertyId', 'WindowVisualState_Normal',
    'AnnotationType_Mathematics', 'UIA_DragPatternId',
    'ZoomUnit_LargeIncrement', 'AnnotationType_Footnote',
    'UIA_NavigationLandmarkTypeId', 'UIA_FillColorPropertyId',
    'TreeTraversalOptions', 'UIA_CapStyleAttributeId',
    'UIA_TextPatternId', 'UIA_FillTypePropertyId',
    'TextPatternRangeEndpoint_Start', 'PropertyConditionFlags',
    'IUIAutomationElement3',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_CalendarControlTypeId', 'IUIAutomationItemContainerPattern',
    'IUIAutomation5', 'UIA_FontWeightAttributeId',
    'UIA_OutlineThicknessPropertyId',
    'UIA_IsValuePatternAvailablePropertyId',
    'IUIAutomationStructureChangedEventHandler',
    'ScrollAmount_SmallDecrement', 'UIA_ClassNamePropertyId',
    'CUIAutomation8', 'IUIAutomationTransformPattern2',
    'HeadingLevel_None',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_DataItemControlTypeId', 'StyleId_Heading1',
    'IUIAutomationObjectModelPattern',
    'UIA_LegacyIAccessibleRolePropertyId', 'UIA_DropTargetPatternId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_SystemAlertEventId', 'TreeTraversalOptions_Default',
    'UIA_StylesPatternId', 'UIA_IsTogglePatternAvailablePropertyId',
    'ZoomUnit_SmallDecrement', 'UIA_IsReadOnlyAttributeId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'ZoomUnit_SmallIncrement', 'UIA_IsDialogPropertyId',
    'NotificationKind_ActionAborted',
    'UIA_MultipleViewCurrentViewPropertyId', 'UIA_FormLandmarkTypeId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_StyleNameAttributeId', 'IUIAutomationDockPattern',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_AnimationStyleAttributeId', 'UIA_AnnotationTypesPropertyId',
    'UIA_DockPatternId', 'UIA_NamePropertyId',
    'UIA_IsSubscriptAttributeId', 'UIA_MarginBottomAttributeId',
    'IUIAutomationValuePattern', 'UIA_IsRequiredForFormPropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_BackgroundColorAttributeId', 'UIA_TableControlTypeId',
    'UIA_DescribedByPropertyId', 'TextUnit_Document',
    'UIA_WindowWindowVisualStatePropertyId', 'TextEditChangeType',
    'UIA_InputReachedTargetEventId', 'UIA_WindowPatternId',
    ...
    'IUIAutomationRangeValuePattern', 'UIA_StyleIdAttributeId',
    'UIA_GridItemColumnPropertyId', 'LiveSetting',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_InputDiscardedEventId', 'UIA_CulturePropertyId',
    'NotificationKind_ItemRemoved',
    'NotificationProcessing_ImportantAll', 'StyleId_Heading5',
    'HeadingLevel5', 'UIA_ToolTipOpenedEventId',
    'IUIAutomationAnnotationPattern', 'UIA_TitleBarControlTypeId',
    'UIA_MarginLeadingAttributeId', 'IUIAutomationScrollItemPattern',
    'WindowInteractionState_Running', 'ScrollAmount',
    'IUIAutomationElement7', 'UIA_IsTablePatternAvailablePropertyId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'OrientationType_Vertical', 'HeadingLevel2',
    'UIA_IndentationLeadingAttributeId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_AriaRolePropertyId',
    'StyleId_Heading6', 'UIA_Transform2CanZoomPropertyId',
    'StyleId_Heading8', 'UIA_ScrollItemPatternId',
    'DockPosition_None', 'UIA_LayoutInvalidatedEventId',
    'UIA_WindowCanMinimizePropertyId', 'ExpandCollapseState_LeafNode',
    'UIA_CustomLandmarkTypeId', 'UIA_TransformPatternId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_MenuClosedEventId', 'UIA_TextControlTypeId',
    'UIA_TableRowOrColumnMajorPropertyId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_VisualEffectsPropertyId', 'WindowInteractionState',
    'ProviderOptions_UseClientCoordinates',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'TextUnit_Character', 'IUIAutomationExpandCollapsePattern',
    'IUIAutomation2', 'UIA_UnderlineStyleAttributeId',
    'UIA_RangeValuePatternId', 'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_ControllerForPropertyId', 'IUIAutomationElement2',
    'UIA_MultipleViewPatternId', 'UIA_VirtualizedItemPatternId',
    'UIA_CustomNavigationPatternId', 'IAccessible', 'IUIAutomation',
    'IUIAutomationBoolCondition', 'UIA_ObjectModelPatternId',
    'SupportedTextSelection_None',
    'AnnotationType_AdvancedProofingIssue',
    'UIA_DragGrabbedItemsPropertyId', 'HeadingLevel9',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_Window_WindowClosedEventId', 'UIA_MenuModeStartEventId',
    'StyleId_Custom', 'UIA_ToolTipClosedEventId',
    'TextEditChangeType_None', 'IUIAutomationTransformPattern',
    'AnnotationType_InsertionChange', 'UIA_DragIsGrabbedPropertyId',
    'HeadingLevel7', 'UIA_SearchLandmarkTypeId',
    'UIA_GridItemRowSpanPropertyId', 'UIA_Text_TextChangedEventId',
    'ProviderOptions_OverrideProvider', 'UIA_NotificationEventId',
    'StyleId_BulletedList', 'UIA_IsDragPatternAvailablePropertyId',
    'UIA_Selection2ItemCountPropertyId',
    'ProviderOptions_RefuseNonClientSupport', 'UIA_ValuePatternId',
    'NotificationProcessing', 'UIA_InvokePatternId',
    'UIA_ControlTypePropertyId', 'OrientationType_Horizontal',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_DropTarget_DragEnterEventId', 'UIA_TextChildPatternId',
    'UIA_DockDockPositionPropertyId', 'TextUnit',
    'UIA_SemanticZoomControlTypeId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'IUIAutomationTableItemPattern', 'IRawElementProviderSimple',
    'UIA_StylesStyleIdPropertyId', 'WindowVisualState_Maximized',
    'UIA_LiveSettingPropertyId', 'UIA_SplitButtonControlTypeId',
    'StyleId_Heading4', 'UIA_MarginTrailingAttributeId',
    'StyleId_Normal',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_IsTransformPattern2AvailablePropertyId', 'HeadingLevel1',
    'UIA_IsPasswordPropertyId', 'UIA_Drag_DragCompleteEventId',
    'RowOrColumnMajor_RowMajor', 'DockPosition_Top', 'TreeScope',
    'PropertyConditionFlags_IgnoreCase', 'UIA_HeadingLevelPropertyId',
    'UIA_AnnotationDateTimePropertyId',
    'ProviderOptions_ProviderOwnsSetFocus', 'TreeScope_Children',
    'IUIAutomationChangesEventHandler', 'UIA_FontNameAttributeId',
    'UIA_ToggleToggleStatePropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'IUIAutomationCacheRequest',
    'NotificationProcessing_ImportantMostRecent',
    'TextPatternRangeEndpoint_End', 'IUIAutomationInvokePattern',
    'UIA_FlowsFromPropertyId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_LegacyIAccessibleStatePropertyId', 'DockPosition_Bottom',
    'UIA_SelectionActiveEndAttributeId', 'NotificationKind_ItemAdded',
    'UIA_ListItemControlTypeId', 'RowOrColumnMajor',
    'UIA_WindowControlTypeId', 'UIA_ListControlTypeId',
    'UIA_TransformPattern2Id', 'UIA_ItemTypePropertyId',
    'NotificationKind_ActionCompleted', 'WindowVisualState_Minimized',
    'UIA_TransformCanMovePropertyId', 'AnnotationType_Footer',
    'IUIAutomationDropTargetPattern',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'AnnotationType_CircularReferenceError',
    'UIA_Selection2FirstSelectedItemPropertyId', 'StyleId_Emphasis',
    'IUIAutomationSpreadsheetItemPattern', 'ScrollAmount_NoAmount',
    'UIA_ForegroundColorAttributeId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_IsPeripheralPropertyId', 'UIA_SliderControlTypeId',
    'UIA_BoundingRectanglePropertyId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_ComboBoxControlTypeId', 'UIA_Drag_DragCancelEventId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_AriaPropertiesPropertyId', 'UIA_TreeItemControlTypeId',
    'ZoomUnit_NoAmount', 'UIA_LevelPropertyId',
    'IUIAutomationProxyFactoryEntry', 'UIA_SizePropertyId',
    'HeadingLevel8', 'ToggleState_On', 'IUIAutomationGridPattern',
    'AnnotationType_ConflictingChange',
    'UIA_Window_WindowOpenedEventId', 'IUIAutomationTextRange3',
    'UIA_AnnotationObjectsAttributeId',
    'UIA_CaretPositionAttributeId', 'TreeScope_Element',
    'AnnotationType_SpellingError',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_ValueValuePropertyId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_TransformCanResizePropertyId', 'OrientationType',
    'StyleId_Title', 'UIA_LandmarkTypePropertyId',
    'UIA_TabsAttributeId', 'UIA_SelectionPattern2Id', 'CUIAutomation',
    'UIA_StructureChangedEventId', 'HeadingLevel6',
    'UIA_IsDataValidForFormPropertyId', 'UIA_HeaderItemControlTypeId',
    'UIA_DocumentControlTypeId', 'IUIAutomationProxyFactory',
    'IUIAutomationEventHandler', 'UIA_GridItemPatternId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'NavigateDirection_LastChild', 'UIA_Drag_DragStartEventId',
    'UIA_CaretBidiModeAttributeId', 'AnnotationType_TrackChanges',
    'IUIAutomationElement6', 'UIA_OutlineColorPropertyId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_InputReachedOtherElementEventId',
    'IUIAutomationSpreadsheetPattern', 'IUIAutomationTextRange2',
    'UIA_CustomControlTypeId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_ProviderDescriptionPropertyId', 'UIA_SeparatorControlTypeId',
    'UIA_TabControlTypeId', 'IUIAutomationMultipleViewPattern',
    'UIA_ProcessIdPropertyId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_LinkAttributeId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'IUIAutomationEventHandlerGroup',
    'UIA_GridItemColumnSpanPropertyId', 'TreeScope_Parent',
    'UIA_Invoke_InvokedEventId', 'TreeScope_Ancestors',
    ...
    'UIA_ImageControlTypeId', 'UIA_ScrollPatternId',
    'UIA_DataGridControlTypeId',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_AcceleratorKeyPropertyId', 'TreeScope_Subtree',
    'CoalesceEventsOptions_Disabled',
    'UIA_Selection_InvalidatedEventId', 'StyleId_Subtitle',
    'IUIAutomationAndCondition', 'UIA_EditControlTypeId',
    'UIA_SynchronizedInputPatternId', 'UIA_MainLandmarkTypeId',
    'Polite', 'IUIAutomationTextPattern',
    'UIA_StylesFillColorPropertyId', 'IUIAutomationStylesPattern',
    'UIA_TogglePatternId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'RowOrColumnMajor_Indeterminate', 'UIA_ThumbControlTypeId',
    'IUIAutomationElement', 'UIA_CenterPointPropertyId',
    'UIA_LiveRegionChangedEventId', 'UIA_SizeOfSetPropertyId',
    'UIA_IsContentElementPropertyId', 'NavigateDirection',
    'UIA_ItemContainerPatternId', 'TextEditChangeType_AutoCorrect',
    'TreeScope_None', 'UIA_RangeValueMaximumPropertyId',
    'AnnotationType_Header', 'UIA_SayAsInterpretAsMetadataId',
    ...
    'AnnotationType_Unknown', 'UIA_LocalizedControlTypePropertyId',
    'UIA_AnnotationAuthorPropertyId', 'UIA_SummaryChangeId',
    'UIA_RadioButtonControlTypeId', 'IUIAutomationElement5',
    'UIA_ChangesEventId', 'UIA_TableItemPatternId',
    'NavigateDirection_NextSibling', 'AnnotationType_Comment',
    'UIA_CultureAttributeId', 'UIA_AnnotationTargetPropertyId',
    'UIA_ValueIsReadOnlyPropertyId', 'IUIAutomationTablePattern',
    'UIA_MenuOpenedEventId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'StructureChangeType_ChildAdded', 'SynchronizedInputType_KeyDown',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_GroupControlTypeId', 'UIA_StylesFillPatternColorPropertyId',
    'IUIAutomationElement9', 'SynchronizedInputType_RightMouseUp',
    'UIA_RangeValueValuePropertyId',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_IsAnnotationPatternAvailablePropertyId', 'IUIAutomation6',
    'SupportedTextSelection', 'AutomationElementMode_None',
    'UIA_SelectionItemPatternId', 'UIA_ClickablePointPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_IsItemContainerPatternAvailablePropertyId', 'ZoomUnit',
    'NotificationKind', 'UIA_SelectionSelectionPropertyId',
    'ProviderOptions_HasNativeIAccessible', 'UIA_AccessKeyPropertyId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_StylesFillPatternStylePropertyId',
    'IUIAutomationSelectionPattern'
]

_check_version('1.1.14', 1655360393.930064)
